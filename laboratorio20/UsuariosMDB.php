    ...
    class UsuariosMDB{
        ...
        public function insertarRegistro($nombre,$apellido,$email,$edad){
            try{
                ...
                echo "Ocurrio la siguiente excepcion al tratar de insertar el registro: ", $e->getMessage(), "\n";
            }
        }
        ...
        public function obtenerRegistro(){
            try{
                ...
                echo "Ocurrio la siguiente excepcion al tratar de obtener los registros: ", $e->getMessage(), "\n";
            }
        }
    }
?>